      ...
      <div className="flex items-start justify-between gap-5">
        <div className="flex min-w-0 items-start gap-4">
          ...
          <div className="min-w-0">
            <h2
              id="cep-modal-title"
              className="text-foreground font-serif text-2xl font-semibold leading-tight"
            >
              Onde você está?
            </h2>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="border-border bg-background text-foreground placeholder:text-muted/50 focus:border-primary focus:ring-primary/10 h-14 w-full rounded-2xl border pr-4 pl-10 text-sm font-medium outline-none transition focus:ring-2"
            />
          </div>
            ...
            {loadingAddress ? (
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-foreground mt-1.5 text-sm font-semibold leading-6">
                    {getFullAddress()}
                  </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted mt-1.5 text-[11px] leading-5">
                ...
                peso, as dimensões do pacote e as condições da transportadora.
              </p>
            </div>
          </div>
        </div>
