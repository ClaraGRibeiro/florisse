...
`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 md:p-6">
      ...
      {/* Backdrop Padronizado (Fundo que escurece e dá o blur) */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      {/* Caixa do Carrinho Padronizada (Popup com efeito de escala e subida) */}
      <motion.div
                          ...
                          <div className="text-right">
                            ...
                            {item.no_discount && (
                              <p className="whitespace-nowrap text-sm font-medium text-muted line-through">
                                R$ {(item.no_discount * item.quantity).toFixed(2)}
                              </p>
                            )}
                          </div>
                        </div>
